...
(function () {
    ...
    function buildPreset(preset, color) {
        ...
        switch (preset) {
            ...
            case 'lamp': {
                addMesh(group, new THREE.CylinderGeometry(0.14, 0.16, 0.1, 24), accent, new THREE.Vector3(0, -0.42, 0));
                addMesh(group, new THREE.CylinderGeometry(0.05, 0.05, 0.52, 16), c, new THREE.Vector3(0, -0.12, 0));
                addMesh(group, new THREE.ConeGeometry(0.4, 0.44, 32, 1, true), accent, new THREE.Vector3(0, 0.36, 0));
                addMesh(group, new THREE.SphereGeometry(0.09, 16, 16), new THREE.Color('#fde68a'), new THREE.Vector3(0, 0.14, 0));
                break;
            }
            case 'shoe': {
                addMesh(group, new THREE.BoxGeometry(0.95, 0.28, 0.42), c, new THREE.Vector3(0, -0.05, 0.02), new THREE.Vector3(0, 0.15, 0));
                addMesh(group, new THREE.BoxGeometry(0.35, 0.42, 0.32), accent, new THREE.Vector3(-0.18, 0.18, -0.08), new THREE.Vector3(0.2, 0, 0));
                addMesh(group, new THREE.BoxGeometry(0.72, 0.12, 0.38), accent, new THREE.Vector3(0.08, 0.02, 0.04));
                break;
            }
            default: {
    ...
    function markFallback(el) {
        el.classList.add('sh-3d-fallback');
        markReady(el);
    }
