...
$en = [
    ...
    'analytics' => [
        ...
        'hints' => [
            ...
            'tracking_tiktok_pixel' => 'Pixel ID from TikTok Events Manager → Web Events → TikTok Pixel.',
...
$uk = [
    'store' => [
        'intro' => 'Основні налаштування вітрини: відкрити/закрити крамницю та валюта.',
        'guide' => [
            ...
            'links' => [],
            'note' => 'Поки крамниця закрита, відвідувачі бачать сторінку «на розробці».',
        ],
        'sections' => [
    ...
    'analytics' => [
        ...
        'hints' => [
            ...
            'tracking_tiktok_pixel' => 'ID пікселя з TikTok Events Manager → Web Events → TikTok Pixel.',
    ...
    'seo' => [
        'intro' => 'Допоможіть Google і соцмережам зрозуміти вашу крамницю: глобальні meta-теги, OG-зображення та Schema.org для товарів.',
        'guide' => [
            'title' => 'SEO та Schema',
