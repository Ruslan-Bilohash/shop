...
/** @return list<array{id:string,title:string,desc:string,class:string,storefront_class:string,tags:list<string>}> */
function sh_design_themes(?array $labels = null, bool $storefrontOnly = false): array
{
    ...
    $all = [
        [
            ...
            'class' => 'adm-dd--nordic',
            'storefront_class' => 'sh-theme--nordic',
        ...
        [
            ...
            'class' => 'adm-dd--dark',
            'storefront_class' => 'sh-theme--dark',
        ...
        [
            ...
            'class' => 'adm-dd--fresh',
            'storefront_class' => 'sh-theme--fresh',
        ...
        [
            ...
            'class' => 'adm-dd--bold',
            'storefront_class' => 'sh-theme--bold',
        ...
        [
            ...
            'class' => 'adm-dd--ocean',
            'storefront_class' => 'sh-theme--ocean',
        ...
        [
            ...
            'class' => 'adm-dd--coral',
            'storefront_class' => 'sh-theme--coral',
        ...
        [
            ...
            'class' => 'adm-dd--retro',
            'storefront_class' => 'sh-theme--retro',
        ...
        [
            ...
            'class' => 'adm-dd--neon',
            'storefront_class' => 'sh-theme--neon',
            'tags'  => ['neon', 'gaming', 'tech', 'cyan', 'dark'],
        ],
    ];

    if ($storefrontOnly) {
        $ids = function_exists('sh_storefront_theme_ids') ? sh_storefront_theme_ids() : ['nordic', 'dark', 'fresh', 'bold', 'ocean', 'coral'];
        return array_values(array_filter($all, static fn(array $row): bool => in_array($row['id'], $ids, true)));
    }
    return $all;
}
